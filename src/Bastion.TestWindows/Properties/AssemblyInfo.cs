...
// live desktop session; TestWindowSpawner.Run/WndProc/WatchStdinForShutdownSignal need one and are
// exercised only by the not-yet-built Tier 3 harness (DESIGN.md §11) this issue explicitly
// excludes.
